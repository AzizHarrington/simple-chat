...
Elm.SimpleChat.make = function (_elm) {
   "use strict";
   _elm.SimpleChat = _elm.SimpleChat || {};
   if (_elm.SimpleChat.values) return _elm.SimpleChat.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var formatMessage = function (m) {
      ...
      _U.list([$Html.text(A2($Basics._op["++"],"[",A2($Basics._op["++"],m.time,"]")))
              ,$Html.text(" ")
              ,$Html.text(A2($Basics._op["++"],"[",A2($Basics._op["++"],m.name,"]")))
              ,$Html.text("=> ")
              ,$Html.text(m.text)]));
   };
